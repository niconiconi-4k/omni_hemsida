// External JSON i18n loader; now with inlined dictionaries to avoid fetch() so site works under file://
(function(){
  const STORAGE_KEY = 'omni_lang';
  // Dynamically resolve lang path based on script location (kept for compatibility)
  ...
  // Inlined language dictionaries (copied from lang/zh.json and lang/en.json)
  // Keep lang/*.json files as source-of-truth in the repo; these inlined DICTS improve local/file:// behavior.
  const DICTS = {
    "zh": {
  "nav.scenes": "应用场景",
  "nav.features": "特点",
  ...
  // loadLang now resolves to the inlined DICTS, avoiding fetch()
